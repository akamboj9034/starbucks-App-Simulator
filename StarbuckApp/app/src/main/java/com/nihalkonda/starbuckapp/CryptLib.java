...
public class CryptLib {
    ...
    public CryptLib(String key) throws NoSuchAlgorithmException, NoSuchPaddingException {
    ...
    public String encrypt(String str) throws Exception {
        return encryptPlainTextWithRandomIV(str,key);
    }

    public String decrypt(String str) throws Exception {
        return decryptCipherTextWithRandomIV(str,key);
    }
